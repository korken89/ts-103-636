...
// ---------------------------------------------------------------------------
// Beta - Fourier transform scaling factor beta
// ETSI TS 103 636-3, clause 4.3 (and tables therein).
// ---------------------------------------------------------------------------
...
// ETSI TS 103 636-3, Annex A, Table A-1
// ---------------------------------------------------------------------------
...
impl Mcs {
    ...
    /// Human-readable description, e.g. "QPSK r=1/2". Returns `None` for
    /// out-of-range indices (which cannot exist by construction, but kept
    /// for symmetry with other enums).
    #[must_use]
...
// ---------------------------------------------------------------------------
// MacExt - 2-bit MAC Extension field
// ETSI TS 103 636-4, clause 6.3.4, Table 6.3.4-1
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// AllocationType - 2-bit Resource Allocation type
...
// ---------------------------------------------------------------------------
// TransmitPower - 4-bit field, ETSI TS 103 636-4, clause 6.2.1, Table 6.2.1-3a
// ---------------------------------------------------------------------------
